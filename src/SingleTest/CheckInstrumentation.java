...
public class CheckInstrumentation {
	...
	public void setUp(){
		current_test_number++;
		System.out.println("Starting 'before' method on test number " + current_test_number + " from " + total_number_of_tests);
	...
	public void testCheckInstrumentedfmr_ios() {
		try{
			Assert.assertTrue("The device model for this test - testCheckInstrumentedfmr_ios -  must be 'iphone'. but instead it's: " + model, model.equals("iPhone"));
	...
	public void testCheckInstrumentedsap(){
		try{
			Assert.assertTrue("The device model for this test -  testCheckInstrumentedsap - must be 'iPad'. but instead it's: " + model, model.equals("iPad"));
	...
	public void testCheckInstrumentedShaadi(){
		try{
			Assert.assertTrue("The device model for this test - "+test_name.getMethodName()+"- must be 'iphone'. but instead it's: " + model, model.equals("iPhone"));
	...
	public void tearDown(){
		...
		System.out.println("Finished 'after' method on test number " + current_test_number + " from " + total_number_of_tests);
	}
