...
public class MultipleSites extends AbsTest{
    ...
    private Map<String, String> getSites() {
        ...
        sitesMap.put("www.apple.com", "//*[@id='ac-gn-firstfocus-small']");
        sitesMap.put("www.youtube.com", "xpath=//*[@class='_moec _mvgc']");
        sitesMap.put("www.facebook.com", "xpath=//*[@id='header']");
        sitesMap.put("www.baidu.com", "xpath=//*[@id='logo']");
        sitesMap.put("www.wikipedia.org", "xpath=//*[@alt='WikipediA']");
        sitesMap.put("www.yahoo.com", "xpath=//*[@id='yucs-logo-img']");
        sitesMap.put("www.twitter.com", "xpath=//*[@class='AppBar-icon Icon Icon--twitter']");
        ...
        sitesMap.put("www.dropbox.com", "xpath=//*[@class='dropbox-logo__type']");
